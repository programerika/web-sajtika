    ...
    <div>
      ...
      >
        ...
        <p>
          ...
          in React.js with Redux in front end and Java Springboot with MongoDB
          ...
          <br></br>
          You can review game source code organized into
          two git repositories for front end project and back end project. 
          GIT links are available in the footer.
          <br></br>
          <br></br>
        </p>        
